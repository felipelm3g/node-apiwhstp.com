...
async function parseRequestObject(requestObject) {
    ...
    if (contentType === 'application/x-www-form-urlencoded' && requestObject.formData === undefined) {
        ...
        if (requestObject.formData !== undefined && requestObject.formData instanceof form_data_1.default) {
            ...
            axiosConfig.data = (0, axios_utils_1.createFormDataObject)(allData);
        }
        delete axiosConfig.headers?.[contentTypeHeaderKeyName];
        const headers = axiosConfig.data.getHeaders();
        axiosConfig.headers = Object.assign(axiosConfig.headers || {}, headers);
        await (0, axios_utils_1.generateContentLengthHeader)(axiosConfig);
    }
    else {
        if (requestObject.form !== undefined && requestObject.body === undefined) {
            ...
            if (axiosConfig.headers !== undefined) {
                const headerName = (0, axios_utils_1.searchForHeader)(axiosConfig, 'content-type');
                if (headerName) {
            ...
            if (requestObject.formData instanceof form_data_1.default) {
                ...
                axiosConfig.data = (0, axios_utils_1.createFormDataObject)(requestObject.formData);
            }
            const headers = axiosConfig.data.getHeaders();
            axiosConfig.headers = Object.assign(axiosConfig.headers || {}, headers);
            await (0, axios_utils_1.generateContentLengthHeader)(axiosConfig);
    ...
    const host = (0, axios_utils_1.getHostFromRequestObject)(requestObject);
    ...
    (0, axios_utils_1.setAxiosAgents)(axiosConfig, agentOptions, requestObject.proxy);
    axiosConfig.beforeRedirect = (0, axios_utils_1.getBeforeRedirectFn)(agentOptions, axiosConfig, requestObject.proxy, requestObject.sendCredentialsOnCrossOriginRedirect ?? true, requestObject.allowedDomains);
...
function convertN8nRequestToAxios(n8nRequest) {
    ...
    (0, axios_utils_1.setAxiosAgents)(axiosRequest, agentOptions, proxy);
    axiosRequest.beforeRedirect = (0, axios_utils_1.getBeforeRedirectFn)(agentOptions, axiosRequest, n8nRequest.proxy, n8nRequest.sendCredentialsOnCrossOriginRedirect ?? true, n8nRequest.allowedDomains);
    ...
    const userAgentHeader = (0, axios_utils_1.searchForHeader)(axiosRequest, 'user-agent');
    if (!userAgentHeader) {
        axiosRequest.headers = {
            ...axiosRequest.headers,
            'User-Agent': 'n8n',
